...
/*
const u16 Picture[] = {
  B, B, B, M, W, B, W, W, W, W, W, W, B, B, B, B,
  B, B, B, B, B, W, W, W, W, W, W, W, W, B, B, B,
  B, B, B, B, W, W, W, M, M, B, M, B, M, B, B, B,
  B, B, B, B, W, W, W, M, M, B, M, B, M, B, B, B,
  B, B, B, B, B, W, W, W, W, W, W, W, W, B, B, B,
  B, B, B, B, B, L, W, W, W, W, W, W, B, B, B, B,
  B, B, B, B, B, L, L, L, L, L, L, B, B, B, B, B,
  B, B, B, B, L, L, W, W, W, L, B, M, M, B, B, B,
  B, B, M, M, L, L, W, W, W, W, W, M, M, B, B, B,
  B, B, M, M, L, L, L, W, W, W, W, B, B, B, B, B,
  B, B, B, B, L, L, L, L, L, L, B, B, M, B, B, B,
  B, B, B, B, L, L, W, L, L, L, W, M, M, B, B, B,
  B, B, B, W, W, W, W, L, L, W, W, M, M, B, B, B,
  B, B, M, M, W, W, W, B, L, L, W, M, M, B, B, B,
  B, B, B, M, M, B, B, B, B, B, B, B, B, B, B, B,
  B, B, B, B, M, M, B, B, B, B, B, B, B, B, B, B
};
*/
...
const u16 Pattern[] = {
  ...
  B3<<15|B3<<14|M3<<13|M3<<12|W3<<11|W3<<10|W3<<9|B3<<8|L3<<7|L3<<6|W3<<5|M3<<4|M3<<3|B3<<2|B3<<1|B3<<0,
